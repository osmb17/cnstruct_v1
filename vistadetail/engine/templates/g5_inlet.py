"""
Caltrans D72 CIP Drainage Inlet Type G5.

Detail A profile -- #5 all around. Standard W = 2'-11¾".
"""
...
class G5InletTemplate(BaseTemplate):
    def __init__(self):
        super().__init__()
        self.name = "G5 Inlet"
        self.version = "1.0"
        self.description = (
            "Caltrans D72B -- CIP Drainage Inlet Type G5. "
            "Detail A profile, #5 all around, std W=2'-11¾\"."
        )
        self.inputs = [
