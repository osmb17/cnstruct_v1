...
class HeadwallTemplate(BaseTemplate):
    ...
    def __init__(self):
        ...
        self.inputs = [
            ...
            InputField("top_spacing_in",   float, label="Top Bar Spacing (in)", min=6.0, max=18.0, default=12.0),
            ...
            InputField("c_bar_spacing_in", float, label="C-bar Spacing (in)",  min=6.0, max=18.0, default=9.0,
            ...
            InputField("fdn_mat_spacing_in", float, label="Fdn Mat Spacing (in)",  min=6.0, max=18.0, default=12.0,
                       hint="Spacing of FM1 mat bars along wall width"),
            InputField("fdn_horiz_spacing_in", float, label="Fdn Horiz Spacing (in)", min=6.0, max=18.0, default=8.0,
            ...
            InputField("d_bar_spacing_in",   float, label="D-bar Spacing (in)",     min=6.0, max=18.0, default=8.0),
