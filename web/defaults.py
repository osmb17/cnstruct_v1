...
PRIMARY_INPUTS: dict[str, list[str]] = {
    ...
    "G2 Expanded Inlet Top": ["x_dim_ft", "wall_thick_in",
                              "wall_height_ft", "grate_type", "num_structures"],
    "Straight Headwall":     ["loading_case",
    ...
    "Junction Structure":    ["d1_in", "d2_in", "span_ft", "hb_ft",
                              "max_earth_cover_ft", "num_structures"],
...
DIAGRAM_LABELS: dict[str, dict[str, str]] = {
    ...
    "G2 Expanded Inlet Top": {"x_dim_ft": "X", "wall_thick_in": "T", "wall_height_ft": "H"},
