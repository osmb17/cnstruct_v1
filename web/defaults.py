...
PRIMARY_INPUTS: dict[str, list[str]] = {
    ...
    "G2 Expanded Inlet":     ["x_dim_ft", "y_dim_ft", "y_expanded_ft",
                              ...
                              "grate_type", "num_structures"],
    "G2 Inlet Top":          ["x_dim_ft", "wall_thick_in", "y_dim_ft",
                              "wall_height_ft", "grate_type", "num_structures"],
    "G2 Expanded Inlet Top": ["x_dim_ft", "y_dim_ft", "wall_thick_in",
                              "wall_height_ft", "grate_type", "num_structures"],
    ...
    "Junction Structure":    ["d1_in", "d2_in", "span_ft", "length_ft", "hb_ft",
                              "max_earth_cover_ft", "has_manhole",
                              "side_pipe_dia_in", "num_structures"],
...
DIAGRAM_LABELS: dict[str, dict[str, str]] = {
    ...
    "G2 Inlet Top":          {"x_dim_ft": "X", "y_dim_ft": "Y", "wall_thick_in": "T", "wall_height_ft": "H"},
    "G2 Expanded Inlet Top": {"x_dim_ft": "X", "y_dim_ft": "Y", "wall_thick_in": "T", "wall_height_ft": "H"},
    ...
    "Junction Structure":    {"span_ft": "Span", "length_ft": "Length", "hb_ft": "HB"},
